...
IF NOT EXISTS (
    SELECT 1 
    FROM housekeep_fields 
    WHERE field_desc = 'Car Plate Number'
      AND field_name = 'c.car_plateno|S'
)
BEGIN
    INSERT INTO housekeep_fields (
        id, field_name, field_desc, field_desc2, field_desc3, field_desc4, field_desc5,
        field_desc6, field_desc7, field_desc8, field_desc9, field_desc10, sort_seq, field_len
    )
    VALUES (
        3, 'c.car_plateno|S', 'Car Plate Number', 
        'Nombor Plat Kenderaan', 'Nomor Plat Kendaraan', N'Số biển số xe',
        NULL, NULL, NULL, NULL, NULL, NULL, 44, 0
    );
END
GO
